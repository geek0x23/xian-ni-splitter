...
def run(source):
    ...
    for book in books:
        ...
        shutil.copy2(source_path.joinpath("OEBPS", "cover.xhtml"), oebps_path.joinpath("cover.xhtml"))
        ...
        shutil.copy2(source_path.joinpath("mimetype"), book_path.joinpath("mimetype"))
